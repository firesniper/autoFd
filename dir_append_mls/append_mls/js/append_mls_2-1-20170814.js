var fnPgp_getDefUrl = function ( pgp_params )
{
	...
	var pgp_defUrl = pgp_params && pgp_params.pgp_defUrl ? pgp_params.pgp_defUrl :
	{
		meta : [ ] ,
		link : [ ] ,
		script : [
...
(
	...
	// 			if ( $args == null || $args == undefined ) return ;
		...
		"fnPgp_assignPgpNestPgp" :
		{
			enemerable : false ,
			configurable : true ,
			writable : true ,
			value : function ( pgp_a )
			{
				var _this = this ;
				var pgp_b = _this ;
				var pgp_new = {} ;
				for ( var key in pgp_b )
				{
					pgp_new [ key ] = Object.assign 
					( 
						pgp_a [ key ] ,
						pgp_b [ key ]
					) ;
...
(
	Array.prototype ,
	{
		...
		"fnPgp_combinePgpNestPgp" :
		{
			...
			configurable : true ,
			writable : true ,
			value : Object.prototype.fnPgp_combinePgpNestPgp ,
		} , 
		"defFlag" :
		{
			enumerable : false ,
		...
		"pgp_envOpt" : 
		{
			...
			value : 
			{
				"dev" :
				{
					...
					any_browBaseUrl : document.baseURI
				} ,
				"pro" :
				{
	...
	Object ,
	{
		"bol_isNullJson" :
		{
			...
			value : function ( json )
			{
				var bol_res = true ;
				var _this = this ;
				var json = json ? json : _this ;
				if ( json && Object.keys( json ) [ 0 ] )
				{
					key : for ( var key in json )
					{
						if ( json [ key ] && json [ key ] [ 0 ] )
						{
							ele : for ( var ele in json [ key ] )
							{
								if 
								( 
									json [ key ] [ ele ] 
									&& 
									Object.keys ( json [ key ] [ ele ] ) [ 0 ]
								) 
								{
									bol_res = false ;
								} 
		...
		"fnPgp_getEnvState" :
		{
			...
			value : function ( pgp_params )
			{
				...
				var num_virPath = pgp_params && pgp_params.num_virPath ? pgp_params.num_virPath : 2 ;
				var pgp_envOpt	= pgp_params && pgp_params.pgp_envOpt ? pgp_params.pgp_envOpt :  Object.pgp_envOpt ;
				var str_emerDir = pgp_params && pgp_params.str_emerDir ?
								pgp_params.str_emerDir :
								"/emerData/" ;
				
				pgp_envOpt.fnPgp_assignPgpNestPgp ( Object.pgp_envOpt ) ;
				// pgp_envOpt.fnPgp_combinePgpNestPgp ( Object.pgp_envOpt ) ;
				...
				for ( var a in Object.pgp_envOpt )
				{
					bol_envOptIndi =  
					( 
						new RegExp 
						( 
							"(?:" 
							+ Object.pgp_envOpt [ a ] [ "ary_indicate" ] .join ( "|" ) 
							+ ")" 
							, 
							"ig" 
						) 
					...
					{
						str_envOptIndi = a ;
						pgp_newNull_envOpt = Object.pgp_envOpt [ a ] ;
					} ;
				} ;
				...
				window.pgp_envState = 
				{
					...
					// "str_emerDir"			: str_emerDir 
				} ; 	
				if ( str_emerDir ) 
				{
					window.pgp_envState.pgp_envOpt.str_emerDir = str_emerDir ;
				} ;
				if ( location.search )
				{
					window.pgp_envState.pgp_envOpt.str_docSerh = location.search ;
				} ;
	...
	String.prototype ,
	{
		"fnPgp_getDocSerh" : 
		{
			...
			value : function ( urlStrOpt )
			{
				...
				var searchStr = location && location.search ? location.search : searchStr = urlStrDef.match( /\?+.*$/ig ) ? searchStr [ 0 ] : null ;
				if ( !searchStr ) { console.info ( "haven't search" ) ; return ; } ;
				...
				window.pgp_envState.pgp_envOpt.pgp_docSerh = obj ;
				return obj ;
			} ,
		} ,
	}
...
(
	Object.prototype ,
	{
		"fnStr_cvtPgpDocSerh" :
		{
			...
			configurable : true ,
			writable : true ,
			value : function ( pgp_docSerh )
			{
				var _this = this ;
				pgp_docSerh = pgp_docSerh || _this ;
				var str_serh = pgp_docSerh [ "tbNamesStr" ] ? 
					  "&tbNamesStr=" + pgp_docSerh [ "tbNamesStr" ] :
					   pgp_docSerh [ "dicStr" ] ?
					  "&dicStr=" + pgp_docSerh [ "dicStr" ]	:
					  undefined ;
				var arys_serhSum = [ "?" ] ;
				for ( var key in pgp_docSerh )
				{
					arys_serhSum.push ( key + "=" + pgp_docSerh [ key ] + "&" ) ; 
				} ;
				window.pgp_envState.pgp_envOpt.str_docSerh = arys_serhSum.join ( "" ) ;
				return str_serh ;
			}
		} ,
		"fnStr_getAppParams" :
		...
		"fnStr_getServEmerUrl" : 
		{
			...
			value : function ( params )
			{
				...
				var str_servEmerUrl = pgp_envState.str_baseUrl 
								...
								+ ".js" 
								;
				window.pgp_envState.pgp_envOpt.str_servEmerUrl = str_servEmerUrl ;
				return str_servEmerUrl ; 
			} 
		} ,
		"fnStr_getServWholeUri" :
		{
			enumerable : false ,
			configurable : true ,
			writable : true ,
			value : function ( params ) 
			{
				...
				var str_servWholeUri = pgp_envState.pgp_envOpt.any_servBaseUrl 
											+ str_appParams ; 
				window.pgp_envState.pgp_envOpt.str_servWholeUri = str_servWholeUri ;
...
(
	Object.prototype ,
	{
		"fn_bootDocSerhExtendEnvState" :
		{
			...
			value : function ( params )
			{
				var pgp_docSerh =  params ? 
									params.pgp_docSerh || String.prototype.fnPgp_getDocSerh () :
									this ;
									
				if ( !pgp_docSerh ) { console.info ( "haven't search" ) ; return ; } ;
				window.pgp_envState.pgp_envOpt.pgp_docSerh = pgp_docSerh ;
				pgp_docSerh.fnStr_cvtPgpDocSerh () ;
				( pgp_docSerh/* || Object.prototype*/ ).fnStr_getServEmerUrl () ;
				( pgp_docSerh/* || Object.prototype*/ ).fnStr_getServWholeUri () ;
...
var append_mls = 
{
	...
	config : function ( pgp_params )
	{
		...
		Object.prototype.fn_bootDocSerhExtendEnvState ( {} ) ;
	...
	appendMeta : function ( urlPgp , isAsyn )
	{
		...
		function () 
		{
			...
			return urlPgp.meta ;
			resUrlObj = window.pgp_defUrl.meta.fnPgp_combinePgpNestPgp ( urlPgp.meta ) ;
